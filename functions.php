...
function silverjournal_enqueue_scripts() {
    ...
    wp_enqueue_style('google-fonts', 'https://fonts.googleapis.com/css2?family=Oswald:wght@200..700&display=swap', [], null, 'all');
    ...
    if (is_front_page()) {
        ...
        wp_enqueue_style('homepage-css', get_template_directory_uri() . '/css/global.css', [], '1.0.0', 'all');
